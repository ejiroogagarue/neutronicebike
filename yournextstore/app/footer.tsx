...
const footerLinks = {
	shop: [{ href: "/catalog", label: "Bikes" }, { href: "/rental", label: "Rental" }],
	resources: [
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="py-8 sm:py-12 lg:py-14 flex flex-col sm:flex-row gap-6 sm:gap-12 lg:gap-16">
					<div className="sm:max-w-xs lg:max-w-sm shrink-0">
						<Link href="/" className="text-lg sm:text-xl lg:text-2xl font-bold italic text-[#0a0d0f] hover:text-[#0a0d0f]/80 transition-colors">
							Neutronic E-Bikes
						</Link>
				...
				<div className="py-4 sm:py-5 lg:py-6 border-t border-[#0a0d0f]/10">
					<p className="text-xs sm:text-sm text-[#0a0d0f]/60">
						&copy; {new Date().getFullYear()} Neutronic. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
